# -*- encoding: utf-8 -*-
# stub: chef-utils 16.6.14 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "Basic utility functions for Core Chef development".freeze
