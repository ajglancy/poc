...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<train-core>.freeze, ["= 3.3.27"])
    ...
    s.add_runtime_dependency(%q<google-api-client>.freeze, [">= 0.23.9", "< 0.44.1"])
    s.add_runtime_dependency(%q<googleauth>.freeze, [">= 0.6.6", "< 0.13.1"])
  else
    s.add_dependency(%q<train-core>.freeze, ["= 3.3.27"])
    ...
    s.add_dependency(%q<google-api-client>.freeze, [">= 0.23.9", "< 0.44.1"])
    s.add_dependency(%q<googleauth>.freeze, [">= 0.6.6", "< 0.13.1"])
  end
end
