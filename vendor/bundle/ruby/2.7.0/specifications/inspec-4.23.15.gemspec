...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<inspec-core>.freeze, ["= 4.23.15"])
    s.add_runtime_dependency(%q<train>.freeze, ["~> 3.0"])
    s.add_runtime_dependency(%q<faraday_middleware>.freeze, [">= 0.12.2", "< 1.1"])
    ...
    s.add_dependency(%q<inspec-core>.freeze, ["= 4.23.15"])
    s.add_dependency(%q<train>.freeze, ["~> 3.0"])
    s.add_dependency(%q<faraday_middleware>.freeze, [">= 0.12.2", "< 1.1"])
